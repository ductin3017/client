		...
		<>
			...
			<div className="w-[500px] bg-[#fff] box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; px-5 py-2 rounded-md">
				<div className="flex justify-end">
					<TiDelete
						onClick={clickClose}
						className="bg-red-500 text-[#fff] rounded-full w-[20px] h-[20px] cursor-pointer"
					/>
				</div>
				...
				{/* nhãn sách */}
				<input
					onChange={(e) => setLabelBook(e.target.value)}
					type="text"
					name="labelBook"
				...
				{/* ảnh sách */}
				<input
					onChange={(e) => setImgBook(e.target.value)}
					type="text"
					name="imgBook"
					className="w-full p-2 rounded-md border mb-3"
				/>
				...
				<button
					onClick={clickClose}
					className="w-full bg-red-500 text-[#fff] font-medium p-2 rounded-md hover:bg-red-600 duration-200 ease-in mt-[5px]"
				>
					Hủy
				</button>
			</div>
